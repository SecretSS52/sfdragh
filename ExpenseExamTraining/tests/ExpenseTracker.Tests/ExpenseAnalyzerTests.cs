...
{
    [TestMethod]
    public void Сводка_СчитаетСуммуСреднееИКатегорию()
    {
        var expenses = new[]
        {
    ...
    public void Сводка_ДляПустогоСпискаВозвращаетНули()
    {
        ...
        Assert.AreEqual("нет данных", summary.BiggestCategory);
    }
    ...
    public void Сводка_ЗапрещаетОтрицательныеРасходы()
    {
        ...
        {
            // Это ожидаемое поведение: отрицательный расход запрещен.
        }
    }
}
